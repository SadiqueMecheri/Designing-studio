...
class batchview extends StatefulWidget {
  ...
  @override
  State<batchview> createState() => _viewadmissionsState();
}

class _viewadmissionsState extends State<batchview> {
  CommonViewModel? vm;
        ...
        return CupertinoAlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                    'Are you sure you want to turn ${isActive == 1 ? 'off' : 'on'} this Batch?'),
              ],
            ),
          ),
          actions: <Widget>[
